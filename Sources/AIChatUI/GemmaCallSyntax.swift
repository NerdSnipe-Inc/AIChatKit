import Foundation
// NOTE: intentionally duplicated from AIChatKitMLX (the two packages release independently and
// AIChatUI must not depend on the MLX module). Keep both copies in sync.
